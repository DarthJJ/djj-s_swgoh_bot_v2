...
public class Profile extends BaseCommand {
    ...
    public void createFlags() {
        flags.put(FLAG_RELIC, new Flag(FLAG_RELIC, "Get's relic information about the users roster. optional parameter for level select",true, name, FLAG_RELIC, "<level> (inclusive)"));
